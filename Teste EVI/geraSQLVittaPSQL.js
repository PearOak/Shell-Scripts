    ...
    .then( (dados) => {
        ...
        if (tamRetorno === 0) {
            ...
            for (let i = 0; i < tamRetorno; i++) {
                let insertAtual = `INSERT INTO terrenos_evi.vitta (ticket, fluxo, nomeDoTerreno, regional, cep, endereco, numeroendereco, complemento, bairro, cidade, uf, matrcula, kmz, zreaBruta, zoneamento, inclinaoMdia, infraestruturaUrbana, statusDoTerreno, fluxoDeCompra, cdigoFunoResponszvel) VALUES(`;
